...
categories: 全栈
tags: 全栈
description: 用「双栏式 AI 协作智能文档/网盘」做全栈练手：前端 React + TypeScript，后端 NestJS + PostgreSQL + Prisma，并对接 AI SDK。跟着做可以掌握模块化后端架构、数据库建模与 CRUD、JWT 鉴权、接口校验，以及前后端联调与 AI 能力接入。
---
